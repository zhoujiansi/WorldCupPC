<template>
  <div>
    <div class="minitop">
      <div class="t1">欢迎来到哈希世界杯有奖竞猜环节</div>
      <div class="t2" @click="goIndex">哈希官网</div>
      <div class="t2" @click="goLogin">请登录</div>
    ...
    <div class="login-body" v-show="showLogin">
      <div class="login-body-container">
        ...
        <div class="box-container" v-show="model=='登录'">
          ...
          <img src="../assets/login_top1.png" class="top1">
          <div class="inputbox">
            <div class="box-input">
              <div class="box-icon">
        ...
        <div class="box-container" v-show="model=='会员注册'">
          ...
          <img src="../assets/login_top3.png" class="top1">
          <div class="inputbox">
            <div class="box-input">
              <div class="box-icon">
                <img src="../assets/phone_icon.png" class="phone_icon" />
            ...
            <div class="box-input">
              ...
              <div class="input-container">
                <input type="text" v-model="nickname" maxlength=11 placeholder="您的昵称"/>
              </div>
            </div>
            <div class="box-input">
              <div class="box-icon">
        ...
        <div class="box-container" v-show="model=='找回密码'">
          <img src="../assets/login_top2.png" class="top1">
          <!-- <div class="box-title other">{{model}}</div> -->
          <div class="inputbox">
            <div class="box-input">
              <div class="box-icon">
            ...
            <div class="box-input">
              ...
              <div class="input-container">
                <input type="text" v-model="Email" maxlength=11 placeholder="您的邮箱"/>
              </div>
            </div>
    ...
    <div class="mask" v-show="loginshareshow">
...
export default {
  ...
  methods:{
    closeshow(){
      this.loginshareshow=false;
    },
    goshow(){
      // this.showContainer=true;
      this.loginshareshow=true;
    },
    goIndex(){
      window.location.href="http://www.hach.com.cn/";
    },
    goLogin(){
