  ...
  <div class="result-container">
    ...
    <div class="mybottom">
      <div class="item" @click="select(1)">
        <img src="../assets/bottom1_1.png" class="bg" v-show="selectIndex!=1">
        <img src="../assets/bottom2_1.png" class="bg" v-show="selectIndex==1">
      </div>
      <div class="item" @click="select(2)">
        <img src="../assets/bottom1_2.png"  class="bg" v-show="selectIndex!=2">
        <img src="../assets/bottom2_2.png"  class="bg" v-show="selectIndex==2">
      </div>
      <div class="item" @click="select(3)">
        <img src="../assets/bottom1_3.png"  class="bg" v-show="selectIndex!=3">
        <img src="../assets/bottom2_3.png"  class="bg" v-show="selectIndex==3">
      </div>
      <div class="item" @click="select(4)">
        <img src="../assets/bottom1_4.png"  class="bg" v-show="selectIndex!=4">
        <img src="../assets/bottom2_4.png"  class="bg" v-show="selectIndex==4">
      </div>
      <div class="item" @click="myottomselect()">
        <img src="../assets/bottom1_5.png"  class="bg" v-show="selectIndex!=5">
        <img src="../assets/bottom2_5.png"  class="bg" v-show="selectIndex==5">
      </div>
    </div>
